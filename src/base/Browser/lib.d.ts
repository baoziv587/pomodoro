...
interface IDBCursorRequest {
  error: DOMError;
  onerror: (ev: Event) => any;
  onsuccess: (ev: IDBCursorContext) => any;
  readyState: string;
  result: any;
  source: any;
...
interface IDBObjectStore {
  ...
  openCursor(range?: any, direction?: string): IDBCursorRequest;
...
interface IDBRequest extends IDBEventTarget {
  error: DOMError;
  onerror: (ev: Event) => any;
  onsuccess: (ev: IDBEvent) => any;
  readyState: string;
  result: any;
  source: any;
  transaction: IDBTransaction;
...
interface IDBVersionChangeEvent extends IDBEvent {
  newVersion: number;
  oldVersion: number;
}
